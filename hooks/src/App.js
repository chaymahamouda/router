...
function App() {
  const[movies,setMovies] = useState([
    ...
    },
    {
      ...
      rating: 4,
      Video:"https://www.youtube.com/embed/pAwoA-XPzsQ",
    },
    {
      name: "The Circle",
      posterurl:
    ...
    },
    {
      ...
      rating: 5,
      Video:"https://www.youtube.com/embed/bmtuIhesQWA" ,
    },
    {
      name: "Taxi Driver",
      posterurl:
      ...
      rating: 3,
      Video:"https://www.youtube.com/embed/u9M02nrQIF0",
    },
    {
      name: "Fight Club",
      posterurl:
      ...
      rating: 5,
      Video:"https://www.youtube.com/embed/c_Sf-XY3t-I",
    },
    {
      ...
      rating: 5,
      Video:"https://www.youtube.com/embed/v7v1hIkYH24",
    },
    ...
    },
    {
      ...
      rating: 5,
      Video:"https://www.youtube.com/embed/Rhr5MgN0ARY",
    },
  ])
 ...
 const[rate,setRate]=useState("");
  return (
   ...
   <div className="list">
   <Routes>
    <Route path='/' element={<CardListt movies={movies} text={text} rate={rate} addmovie={addmovie}  />}/>
    <Route path="/Contact" element={<Contact/>}/>
    <Route path="/About" element={<About/>}/>
    <Route path="/Video/:name"element={<Video movies={movies}/>}/>
   </Routes>
